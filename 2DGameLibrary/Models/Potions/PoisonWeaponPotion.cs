...
public class PoisionWeaponPotion : IWeaponPotion
{
    public int MaxDoses { get; init; } = 1;
    public int CurrentDoses { get; set; } = 1;
    public PotionTypes PotionType { get; init; } = PotionTypes.WeaponPoison;
    public string Name { get; set; } = "Poison Weapon Potion";
    ...
    public IWeapon UsePotion(IWeapon weapon)
    {
        ...
        return new PoisionWeaponDecorator(weapon);
    }
}
